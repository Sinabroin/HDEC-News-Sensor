...
- Mobile layout rules: single-column grids, scrollable tabs/tables, stacked rows.
...
def check_generated_mobile_css() -> None:
    ...
    check("mobile tabs scroll within nav",
          ".topnav{top:0;flex-wrap:nowrap;overflow-x:auto" in mobile
          and ".topnav label{flex:0 0 auto" in mobile)
