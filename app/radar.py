...
_RISK_REASON = {
    "중대재해": "중대재해·산업안전 이슈 — 입찰 자격·평판 리스크 점검이 필요합니다.",
    "제재": "제재·영업정지 등 규제 리스크 — 수주 자격 영향을 점검해야 합니다.",
    "규제": "규제·법규 변화 — 컴플라이언스 대응과 사업 영향 점검이 필요합니다.",
    "안전": "현장 안전 이슈 — 안전관리 체계 점검이 필요합니다.",
}
...
def risk_fields(row: dict, score: dict | None) -> dict:
    ...
    return {
        ...
        "risk_reason": _RISK_REASON.get(
            label, "규제·안전 관련 신호로 사업 영향 점검이 필요합니다."),
    }
